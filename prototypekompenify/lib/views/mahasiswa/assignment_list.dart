            ...
            Expanded(
              child: RefreshIndicator(
                ...
                child: assignments.isEmpty
                    // 💡 JIKA KOSONG: Dibungkus ListView agar layarnya tetap bisa ditarik
                    ? ListView(
                        physics: const AlwaysScrollableScrollPhysics(),
                        children: const [
                          SizedBox(
                            height:
                                400, // Tinggi minimum agar tarikan terasa mulus
                            child: EmptyState(
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (ctx, i) {
                          ...
                          final sudahDaftar = a.mahasiswaTerdaftar.contains(
                            svc.currentUser?.id.toString(),
                          );
                          return AssignmentCard(
                            ...
                            trailing: sudahDaftar
                                ...
                                : PrimaryButton(
                                    label: 'Kerjakan',
                                    onTap: () => _pilihAssignment(context, a),
            ...
            onPressed: () {
              ...
              if (ok) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text(
                      '✅ Assignment berhasil dipilih! Silakan upload bukti pengerjaan.',
                    ),
          ...
          child: Column(
            ...
            children: [
              ...
              InfoRow(
                ...
                label: 'Kuota',
                value:
                    '${a.mahasiswaTerdaftar.length}/${a.kuotaMahasiswa} mahasiswa',
              ),
              InfoRow(
                icon: Icons.calendar_today_outlined,
                label: 'Mulai',
                value: DateFormat('dd MMM yyyy').format(a.tanggalMulai),
              ),
              InfoRow(
                icon: Icons.event_outlined,
                label: 'Berakhir',
                value: DateFormat('dd MMM yyyy').format(a.tanggalBerakhir),
              ),
              const SizedBox(height: 16),
              const Text(
                'Deskripsi',
