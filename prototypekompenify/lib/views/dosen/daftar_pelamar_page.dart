...
// Halaman daftar mahasiswa yang mengajukan kompen untuk 1 assignment tertentu
// Dipanggil dari halaman daftar assignment dosen dengan passing AssignmentModel
...
class _DaftarPelamarPageState extends State<DaftarPelamarPage> {
  ...
  try {
    ...
    final url = '$baseUrl/dosen/assignments/${widget.assignment.id}/pengajuan-kompen';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Daftar Pelamar', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
        actions: [
          IconButton(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    _infoChip(Icons.schedule_rounded, '${asg.jamKompen} jam kompen', const Color(0xFF6C63FF)),
                    const SizedBox(width: 8),
                    _infoChip(Icons.people_rounded, '$pendingCount menunggu', const Color(0xFFFFB020)),
                    const SizedBox(width: 8),
  ...
  Widget _buildEmpty() => Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text('Belum ada pelamar', style: TextStyle(color: Colors.grey.shade500, fontSize: 16)),
        ...
        child: Row(
          children: [
            ...
            CircleAvatar(
              ...
              child: Text(inisial, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF6C63FF))),
            ),
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(nama, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Color(0xFF1A1A2E))),
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(fontSize: 12, color: pengajuan.statusColor, fontWeight: FontWeight.w600),
                    ),
                  ),
                ],
              ),
