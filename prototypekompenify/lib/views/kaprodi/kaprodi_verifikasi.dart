              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, idx) => Padding(
                    ...
                    // 🚀 PERBAIKAN: Pasang GESTURE DETECTOR Biar Bisa Diklik
                    child: GestureDetector(
                      onTap: () {
                        // Mengonversi daftar objek buktiFoto menjadi list URL string agar bisa dimakan oleh Viewer
...
void _showTerimaDialog(BuildContext context, PengajuanModel p) {
  showDialog(
    ...
    builder: (_) => AlertDialog(
      ...
      content: const Text('Yakin Pilih Mahasiswa ini ?'),
      actions: [
        TextButton(
