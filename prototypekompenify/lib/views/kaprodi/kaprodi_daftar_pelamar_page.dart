...
class KaprodiDaftarPelamarPage extends StatefulWidget {
  final AssignmentModel assignment;
  const KaprodiDaftarPelamarPage({super.key, required this.assignment});

  @override
  State<KaprodiDaftarPelamarPage> createState() =>
